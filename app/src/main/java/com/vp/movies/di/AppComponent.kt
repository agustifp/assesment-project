...
@Singleton
@Component(modules = [AndroidSupportInjectionModule::class, NetworkModule::class, FavoriteActivityModule::class, MovieListActivityModule::class, DetailActivityModule::class])
